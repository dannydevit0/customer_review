...
// function for displaying star reviews
function starImages(rating){
      let imageText = "";
      for(let i = 1; i <= rating; i++){
            imageText += "<img src = 'star.png' alt = 'star icon'>";
      }
      return imageText;
}

// function to sort out prime and new reviewers
...
// add HTML code to the value of reviewCode variable
...
// write the information into the article tag
